...
import { CreateOrEditStoreModalComponent } from '@app/main/shop/stores/create-or-edit-store-modal.component';
import { ViewStoreModalComponent } from '@app/main/shop/stores/view-store-modal.component';
...
@Component({
  selector: 'app-admin-dashboard-recent-store',
  templateUrl: './admin-dashboard-recent-store.component.html',
  styleUrls: ['./admin-dashboard-recent-store.component.css'],
  animations: [appModuleAnimation()],
})
export class AdminDashboardRecentStoreComponent extends AppComponentBase {
