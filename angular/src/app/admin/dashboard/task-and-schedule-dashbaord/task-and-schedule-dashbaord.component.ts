...
import { TaskWorkItemsServiceProxy, TaskEventsServiceProxy } from '@shared/service-proxies/service-proxies';
import { DateTime } from 'luxon';

@Component({
  selector: 'app-task-and-schedule-dashbaord',
  templateUrl: './task-and-schedule-dashbaord.component.html',
  styleUrls: ['./task-and-schedule-dashbaord.component.css'],
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()],
})
export class TaskAndScheduleDashbaordComponent extends AppComponentBase {
  workItems: any;
  taskEventList: any;
