...
@Component({
    templateUrl: './storeProductCategoryMaps.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class StoreProductCategoryMapsComponent extends AppComponentBase {
    @ViewChild('createOrEditStoreProductCategoryMapModal', { static: true })
    createOrEditStoreProductCategoryMapModal: CreateOrEditStoreProductCategoryMapModalComponent;
    @ViewChild('viewStoreProductCategoryMapModal', { static: true })
    viewStoreProductCategoryMapModal: ViewStoreProductCategoryMapModalComponent;
    ...
    getStoreProductCategoryMaps(event?: LazyLoadEvent) {
    ...
    createStoreProductCategoryMap(): void {
        this.createOrEditStoreProductCategoryMapModal.show();
    }

    deleteStoreProductCategoryMap(storeProductCategoryMap: StoreProductCategoryMapDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._storeProductCategoryMapsServiceProxy.delete(storeProductCategoryMap.id).subscribe(() => {
                    this.reloadPage();
    ...
    exportToExcel(): void {
        this._storeProductCategoryMapsServiceProxy
            .getStoreProductCategoryMapsToExcel(
                this.filterText,
                this.publishedFilter,
                this.maxDisplaySequenceFilter == null
                    ? this.maxDisplaySequenceFilterEmpty
    ...
    resetFilters(): void {
        ...
        this.getStoreProductCategoryMaps();
    }
}
