...
import { StoreMediasServiceProxy, StoreMediaDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './storeMedias.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class StoreMediasComponent extends AppComponentBase {
    @ViewChild('createOrEditStoreMediaModal', { static: true })
    createOrEditStoreMediaModal: CreateOrEditStoreMediaModalComponent;
    @ViewChild('viewStoreMediaModal', { static: true }) viewStoreMediaModal: ViewStoreMediaModalComponent;
    ...
    getStoreMedias(event?: LazyLoadEvent) {
    ...
    createStoreMedia(): void {
        this.createOrEditStoreMediaModal.show();
    }

    deleteStoreMedia(storeMedia: StoreMediaDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._storeMediasServiceProxy.delete(storeMedia.id).subscribe(() => {
                    this.reloadPage();
