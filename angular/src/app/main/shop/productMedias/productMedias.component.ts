...
import { ProductMediasServiceProxy, ProductMediaDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './productMedias.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class ProductMediasComponent extends AppComponentBase {
    @ViewChild('createOrEditProductMediaModal', { static: true })
    createOrEditProductMediaModal: CreateOrEditProductMediaModalComponent;
    @ViewChild('viewProductMediaModal', { static: true }) viewProductMediaModal: ViewProductMediaModalComponent;
    ...
    getProductMedias(event?: LazyLoadEvent) {
    ...
    createProductMedia(): void {
        this.createOrEditProductMediaModal.show();
    }

    deleteProductMedia(productMedia: ProductMediaDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._productMediasServiceProxy.delete(productMedia.id).subscribe(() => {
                    this.reloadPage();
