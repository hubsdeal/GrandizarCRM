...
@NgModule({
    ...
    exports: [ProductMediasComponent, CreateOrEditProductMediaModalComponent, ViewProductMediaModalComponent, ProductMediaMediaLibraryLookupTableModalComponent],
})
