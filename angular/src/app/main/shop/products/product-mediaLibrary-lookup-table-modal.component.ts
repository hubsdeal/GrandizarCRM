...
import { ProductsServiceProxy, ProductMediaLibraryLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class ProductMediaLibraryLookupTableModalComponent extends AppComponentBase {
    ...
    setAndSave(mediaLibrary: ProductMediaLibraryLookupTableDto) {
