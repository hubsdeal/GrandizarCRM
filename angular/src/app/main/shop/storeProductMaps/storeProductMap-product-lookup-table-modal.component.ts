...
@Component({
    selector: 'storeProductMapProductLookupTableModal',
    styleUrls: ['./storeProductMap-product-lookup-table-modal.component.less'],
    encapsulation: ViewEncapsulation.None,
    templateUrl: './storeProductMap-product-lookup-table-modal.component.html',
})
export class StoreProductMapProductLookupTableModalComponent extends AppComponentBase {
    ...
    setAndSave(product: StoreProductMapProductLookupTableDto) {
        this.id = product.id;
