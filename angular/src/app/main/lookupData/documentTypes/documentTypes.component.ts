...
export class DocumentTypesComponent extends AppComponentBase {
    @ViewChild('createOrEditDocumentTypeModal', { static: true })
    createOrEditDocumentTypeModal: CreateOrEditDocumentTypeModalComponent;
    ...
    exportToExcel(): void {
        this._documentTypesServiceProxy
            .getDocumentTypesToExcel(this.filterText, this.nameFilter)
            .subscribe((result) => {
