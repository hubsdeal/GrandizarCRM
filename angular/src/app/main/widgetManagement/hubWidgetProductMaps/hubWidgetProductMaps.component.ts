...
import { HubWidgetProductMapsServiceProxy, HubWidgetProductMapDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './hubWidgetProductMaps.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class HubWidgetProductMapsComponent extends AppComponentBase {
    @ViewChild('createOrEditHubWidgetProductMapModal', { static: true })
    createOrEditHubWidgetProductMapModal: CreateOrEditHubWidgetProductMapModalComponent;
    @ViewChild('viewHubWidgetProductMapModal', { static: true })
    viewHubWidgetProductMapModal: ViewHubWidgetProductMapModalComponent;
    ...
    getHubWidgetProductMaps(event?: LazyLoadEvent) {
    ...
    createHubWidgetProductMap(): void {
        this.createOrEditHubWidgetProductMapModal.show();
    }

    deleteHubWidgetProductMap(hubWidgetProductMap: HubWidgetProductMapDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._hubWidgetProductMapsServiceProxy.delete(hubWidgetProductMap.id).subscribe(() => {
                    this.reloadPage();
    ...
    exportToExcel(): void {
        this._hubWidgetProductMapsServiceProxy
            .getHubWidgetProductMapsToExcel(
                this.filterText,
                this.maxDisplaySequenceFilter == null
                    ? this.maxDisplaySequenceFilterEmpty
                    : this.maxDisplaySequenceFilter,
