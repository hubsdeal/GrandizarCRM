...
import { HubWidgetContentMapsServiceProxy, HubWidgetContentMapDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './hubWidgetContentMaps.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class HubWidgetContentMapsComponent extends AppComponentBase {
    @ViewChild('createOrEditHubWidgetContentMapModal', { static: true })
    createOrEditHubWidgetContentMapModal: CreateOrEditHubWidgetContentMapModalComponent;
    @ViewChild('viewHubWidgetContentMapModal', { static: true })
    viewHubWidgetContentMapModal: ViewHubWidgetContentMapModalComponent;
    ...
    getHubWidgetContentMaps(event?: LazyLoadEvent) {
    ...
    createHubWidgetContentMap(): void {
        this.createOrEditHubWidgetContentMapModal.show();
    }

    deleteHubWidgetContentMap(hubWidgetContentMap: HubWidgetContentMapDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._hubWidgetContentMapsServiceProxy.delete(hubWidgetContentMap.id).subscribe(() => {
                    this.reloadPage();
    ...
    exportToExcel(): void {
        this._hubWidgetContentMapsServiceProxy
            .getHubWidgetContentMapsToExcel(
                this.filterText,
                this.maxDisplaySequenceFilter == null
                    ? this.maxDisplaySequenceFilterEmpty
                    : this.maxDisplaySequenceFilter,
