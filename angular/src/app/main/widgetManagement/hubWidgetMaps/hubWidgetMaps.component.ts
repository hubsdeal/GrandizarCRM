...
export class HubWidgetMapsComponent extends AppComponentBase {
    @ViewChild('createOrEditHubWidgetMapModal', { static: true })
    createOrEditHubWidgetMapModal: CreateOrEditHubWidgetMapModalComponent;
    @ViewChild('viewHubWidgetMapModal', { static: true }) viewHubWidgetMapModal: ViewHubWidgetMapModalComponent;
    ...
    getHubWidgetMaps(event?: LazyLoadEvent) {
    ...
    deleteHubWidgetMap(hubWidgetMap: HubWidgetMapDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._hubWidgetMapsServiceProxy.delete(hubWidgetMap.id).subscribe(() => {
                    this.reloadPage();
