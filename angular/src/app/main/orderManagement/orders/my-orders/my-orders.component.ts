...
import { OrdersServiceProxy, TokenAuthServiceProxy, OrderDto } from '@shared/service-proxies/service-proxies';
...
export class MyOrdersComponent extends AppComponentBase {
