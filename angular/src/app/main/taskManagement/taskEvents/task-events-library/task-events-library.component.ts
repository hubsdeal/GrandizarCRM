...
import { TaskEventsServiceProxy, TaskEventDto, TaskTeamEmployeeLookupTableDto, TaskEventTaskStatusLookupTableDto, TaskTeamsServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'app-task-events-library',
  templateUrl: './task-events-library.component.html',
  styleUrls: ['./task-events-library.component.css'],
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()],
})
export class TaskEventsLibraryComponent extends AppComponentBase {
  @ViewChild('createOrEditTaskEventModal', { static: true })
    ...
    createTaskEvent(): void {
      this.createOrEditTaskEventModal.isFromTaskLibrary=true;
