...
{
    public class SoftGridMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public SoftGridMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(SoftGridConsts.LocalizationSourceName, name);
        }
    }
}