...
{
    public class StripeGatewayManager : SoftGridServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "SoftGrid";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SoftGridConsts.Currency;
        }
