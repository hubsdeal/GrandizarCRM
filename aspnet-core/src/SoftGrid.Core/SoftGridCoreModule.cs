...
using SoftGrid.Authorization.Ldap;
using SoftGrid.Authorization.Roles;
using SoftGrid.Authorization.Users;
using SoftGrid.Chat;
using SoftGrid.Configuration;
using SoftGrid.DashboardCustomization.Definitions;
using SoftGrid.Debugging;
using SoftGrid.DynamicEntityProperties;
using SoftGrid.Features;
using SoftGrid.Friendships;
using SoftGrid.Friendships.Cache;
using SoftGrid.Localization;
using SoftGrid.MultiTenancy;
using SoftGrid.Net.Emailing;
using SoftGrid.Notifications;
using SoftGrid.WebHooks;
using Newtonsoft.Json;

namespace SoftGrid
{
    [DependsOn(
        typeof(SoftGridCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SoftGridCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SoftGridLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SoftGridConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SoftGridMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SoftGridSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SoftGridCoreModule).GetAssembly());
        }
