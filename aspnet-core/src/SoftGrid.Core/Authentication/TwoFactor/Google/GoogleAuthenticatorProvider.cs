...
namespace SoftGrid.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SoftGridServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("SoftGrid", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
