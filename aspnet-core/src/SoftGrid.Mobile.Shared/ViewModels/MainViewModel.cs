...
using SoftGrid.Commands;
using SoftGrid.Core.Threading;
...
using SoftGrid.Controls;
using SoftGrid.Dto;
using SoftGrid.Extensions;
using SoftGrid.Localization;
using SoftGrid.UI;
using SoftGrid.UI.Assets;
using SoftGrid.Views;
using DependencyResolver = SoftGrid.Core.Dependency.DependencyResolver;
...
namespace SoftGrid.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SoftGrid";
