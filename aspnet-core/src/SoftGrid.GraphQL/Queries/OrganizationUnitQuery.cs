...
using SoftGrid.Core.Base;
using SoftGrid.Core.Extensions;
using SoftGrid.Dto;
using SoftGrid.Types;

namespace SoftGrid.Queries
{
    public class OrganizationUnitQuery : SoftGridQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
