...
using SoftGrid.Authorization.Users.Password;
using SoftGrid.Configuration;
using SoftGrid.EntityFrameworkCore;
using SoftGrid.MultiTenancy;
using SoftGrid.Web.Startup.ExternalLoginInfoProviders;
...
namespace SoftGrid.Web.Startup
{
    ...
    public class SoftGridWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SoftGridWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SoftGridWebHostModule).GetAssembly());
        }
