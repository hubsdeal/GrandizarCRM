...
using SoftGrid.Migrations.Seed.Host;
...
namespace SoftGrid.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SoftGridAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SoftGridDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SoftGridConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SoftGridConsts.ConnectionStringName}", constring);
        }
