...
using SoftGrid.Auditing.Exporting;
using SoftGrid.Authorization;
using SoftGrid.Authorization.Users;
using SoftGrid.Dto;
using SoftGrid.EntityHistory;
using EntityHistoryHelper = SoftGrid.EntityHistory.EntityHistoryHelper;

namespace SoftGrid.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SoftGridAppServiceBase, IAuditLogAppService
    {
