...
using SoftGrid.Authentication.TwoFactor.Google;
using SoftGrid.Authorization.Users.Dto;
using SoftGrid.Authorization.Users.Profile.Cache;
...
using SoftGrid.Timing;

namespace SoftGrid.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SoftGridAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("SoftGrid",
