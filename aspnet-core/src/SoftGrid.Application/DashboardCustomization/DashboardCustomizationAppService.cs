...
using SoftGrid.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SoftGrid.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SoftGridAppServiceBase, IDashboardCustomizationAppService
    {
