...
{
    public class SessionAppService : SoftGridAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SoftGridConsts.Currency,
                        CurrencySign = SoftGridConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SoftGridConsts.AllowTenantsToChangeEmailSettings,
