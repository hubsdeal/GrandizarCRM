...
{
    public class SubscriptionPaymentExtensionDataRepository : SoftGridRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SoftGridDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
