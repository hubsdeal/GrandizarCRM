...
using SoftGrid.Url;
using SoftGrid.Web.Public.Startup;
using SoftGrid.Web.Session;
using SoftGrid.Web.UiCustomization;

namespace SoftGrid.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SoftGridViewComponent
    {
