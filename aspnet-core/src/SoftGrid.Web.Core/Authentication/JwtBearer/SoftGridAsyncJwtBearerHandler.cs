...
{
    public class SoftGridAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public SoftGridAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
