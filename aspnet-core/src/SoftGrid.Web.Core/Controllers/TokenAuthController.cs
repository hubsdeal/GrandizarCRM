...
using SoftGrid.Web.Models.TokenAuth;
...
using SoftGrid.Web.Authentication.External;
...
namespace SoftGrid.Web.Controllers
{
    ...
    public class TokenAuthController : SoftGridControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(SoftGridConsts.DateTimeOffsetFormat));
