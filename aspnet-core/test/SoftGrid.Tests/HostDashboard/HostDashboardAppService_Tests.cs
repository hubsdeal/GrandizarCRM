...
using SoftGrid.MultiTenancy.HostDashboard;
...
namespace SoftGrid.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SoftGridDbContext context, SubscriptionPayment subscriptionPayment)
        {
